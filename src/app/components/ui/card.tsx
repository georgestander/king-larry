...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-2xl border border-ink-200/70 bg-white/90 shadow-[0_20px_40px_-30px_rgba(15,23,42,0.35)] backdrop-blur",
        className,
      )}
      {...props}
    />
...
export const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn("text-lg font-semibold text-ink-950 font-[var(--font-display)] tracking-tight", className)}
      {...props}
    />
  ),
);
