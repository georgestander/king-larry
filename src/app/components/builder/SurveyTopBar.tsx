...
export const SurveyTopBar = ({
  ...
  return (
    <>
      <div className="sticky top-24 z-20 rounded-2xl border border-ink-200/70 bg-white/90 p-5 shadow-[0_20px_40px_-35px_rgba(15,23,42,0.35)] backdrop-blur">
                    ...
                    <Card key={run.id} className="border-ink-200/70 bg-white/95 p-4">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button asChild size="sm" variant="outline">
                            <a href={`/surveys/${surveyId}/invite`}>Invite</a>
                          </Button>
                          <Button asChild size="sm">
